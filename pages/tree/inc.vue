  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="n1">
        ...
        <table class="table" style="margin-top:50px;">
          <tr>
            <td class="trm not" style="border-top: none;" colspan="6">
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t13 trm">
              <img class="gg" src="~assets/Kamayukicon.png" width="30" alt="" />
              <div><nuxt-link to="/units/Kamayuk">槍隊長</nuxt-link></div>
            </td>
            <td class="t13 trm">
          ...
          <tr>
            ...
            <td class="t13 trm">
              <img class="gg" src="~assets/Kamayukicon.png" width="30" alt="" />
              <div><nuxt-link to="/units/Kamayuk">精銳槍隊長</nuxt-link></div>
            </td>
            <td class="t13 trm">
              <img
                class="gg"
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t11 trm">
              <img class="gg" src="~assets/MonkIcon2.jpg" width="30" alt="" />
